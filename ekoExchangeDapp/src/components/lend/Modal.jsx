...
import SellFacetAbi from '../../abi/SellFacetAbi.json'
import { Notyf } from 'notyf';
import 'notyf/notyf.min.css'; 

const Modal = ({ setModalOn, setChoice, givingToken, requestingToken, orderInfo }) => {
    const viewFacetAbi = viewFacetAbiz;
    const sellFacetAbiz = SellFacetAbi
    ...
    async function BuyScoreTokenFromSellOrder(){
     if(!isConnected){
      ...
      try{
        ...
        const buy = await exchange.buyScoreTokensFromSellOrder(orderInfo.orderId)
        await buy.wait()
        ...
        <div className="relative w-full h-full max-w-2xl md:h-auto">
            ...
            <form action="#" className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-6 space-y-6">
                    <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3">
                            <label for="first-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Giving EkoStable</label>
                        ...
                        <div className="col-span-6 sm:col-span-3">
                            <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Receiving Score Token</label>
                ...
                <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button onClick={()=> approve()} type="submit" className="text-blue bg-blue-600 hover:bg-red focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-white dark:hover:bg-red-100 dark:focus:ring-blue-800" >Approve</button>
                    <button onClick={() => BuyScoreTokenFromSellOrder()} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buy Token</button>
