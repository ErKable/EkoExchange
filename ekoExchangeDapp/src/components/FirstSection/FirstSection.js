  ...
  <div class="overflow-hidden pt-16">
    <div class="container px-2 mx-auto">
      <div class="flex flex-wrap justify-center">
        ...
        <div class="inline-block mb-6 px-2 py-1 font-semibold bg-green-100 dark:text-the-primary rounded-full">
          ...
          <p class="mb-11 text-lg text-gray-900 dark:text-gray-300 font-medium md:max-w-md">As a member of the Ekolance community, you can swap, lend and exchange your ekostables for ekotokens without hassles. </p>
